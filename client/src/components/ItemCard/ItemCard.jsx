...
export const ItemCard = ({price=0, title='', quantity, img, id}) => {



    const updateQuantity  = useStore((state)=>state.updateQuantity);
    const removeItem = useStore((state)=> state.removeFromCard);



    const handelChange = (value)=>{
        updateQuantity(title, value.value);
    }
