...
export const Home = () => {
  ...
  const updateSelectRestaurant = useStore((state)=> state.updateSelectRestaurant);
      ...
      <div className={s.products__container}>
        ...
        <div className={s.restaurants + ' ' +  (disableRest ? s.restaurantDisable : s.restaurants) }>
        {
          restaurants.map((item,id)=>{
            return (
              <>
                <div className={ s.category + ' ' +  ( item.id === categoryRestaurant ? s.active: '' )} key={id} onClick={ disableRest ? null :  ()=>updateSelectRestaurant(item.id)   }>
